...
DepthCamera.getDepthStream = function () {
    if (!navigator.mediaDevices || !navigator.mediaDevices.enumerateDevices ||
        ...
        return Promise.reject(`Your browser doesn't support the mediaDevices
            API.`);
    ...
    return new Promise(function(resolve, reject) {
        navigator.mediaDevices.enumerateDevices()
            .then(function(all_devices) {
                ...
                // Chrome, starting with version 59, implements getSettings()
                // API.
                ...
                // Select streams from these ids, so that some other camera
                // doesn't get selected (e.g. if the user has another rgb
                // camera).
